				...
				<Flex justify={'flex-start'}>
					<FlexItem>
						<ColorIndicator
							...
							onClick={()=>props.setAttributes({_svSliderArrowsColorPopover: true})}
						/>
					...
					<FlexItem>
						<div>{__('Arrow Color', 'sv_slider')}</div>
					</FlexItem>
				</Flex>
				<Flex justify={'flex-start'}>
					<FlexItem>
						<ColorIndicator
							...
							onClick={()=>props.setAttributes({_svSliderArrowsColorBackgroundPopover: true})}
						/>
					...
					<FlexItem>
						<div>{__('Background Color', 'sv_slider')}</div>
					</FlexItem>
				</Flex>
			</PanelBody>
			{/*
