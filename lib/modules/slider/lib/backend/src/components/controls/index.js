	...
	return (
		<Fragment>
			<SelectControl
				label={__('Layout')}
				options={[
					{label: __('1 Slide per Page', 'sv_slider'), value: ''},
					{label: __('2 Slide per Page', 'sv_slider'), value: 'slider-item-show2'},
					{label: __('3 Slide per Page', 'sv_slider'), value: 'slider-item-show3'},
					{label: __('4 Slide per Page', 'sv_slider'), value: 'slider-item-show4'},
					{label: __('5 Slide per Page', 'sv_slider'), value: 'slider-item-show5'},
					{label: __('6 Slide per Page', 'sv_slider'), value: 'slider-item-show6'},
				]}
